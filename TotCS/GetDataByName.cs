...
namespace TotCS
{
    public partial class Tot
    {
        ...
        public static async Task<string> GetDataByName(string filename, string name, Encoding? encoding = null, int streamCount = DefaultStreamCount)
        {
            try
            {
        ...
        private static async Task<string> ProcessGetDataByName(string filename, string name, Encoding? encoding = null, int streamCount = DefaultStreamCount)
        {
