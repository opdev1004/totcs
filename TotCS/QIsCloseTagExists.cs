...
namespace TotCS
{
    public partial class Tot
    {
        ...
        public async Task<(bool result, long position)> QIsCloseTagExists(string filename, string name, long position = 0, Encoding? encoding = null, int streamCount = DefaultStreamCount)
        {
