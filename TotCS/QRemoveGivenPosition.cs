...
namespace TotCS
{
    ...
    {
        public async Task<bool> QRemoveGivenPosition(string filename, string name, int openPosition, long closePosition, Encoding? encoding = null, int streamCount = DefaultStreamCount)
        {
