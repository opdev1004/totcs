...
namespace TotCS
{
    ...
    {
        public static async Task<bool> RemoveFromGivenPosition(string filename, string name, long openPosition, Encoding? encoding = null, int streamCount = DefaultStreamCount)
        {
            try
            {
